Pod::Spec.new do |s|
  ...
  LICENSE
    ...
    s.subspec 'PlasoLiveMini' do |ss|
      ...
      ss.dependency 'AliPlayerSDK_iOS', '7.12.0-54557273'
      ss.dependency 'AliPlayerSDK_iOS_ARTC', '7.12.0'
      ss.dependency 'RtsSDK', '7.12.0'
      ss.dependency 'MMWormhole','2.0.0'
    
      ss.dependency 'PlasoStyleUpime'
      ss.dependency 'PlasoInnerModule'
      #ss.dependency 'PlasoUpimeSdkModule'
    ...
    s.subspec 'PlasoFeatureWeb' do |ss|
      ...
      ss.resources = ['PlasoLocalized.bundle']
